...
* [Variables and maps](variables-and-maps)
  * [Conventions](variables-and-maps#Conventions)
  * [Available functions](variables-and-maps#available-functions)
    * [Spacing](variables-and-maps#spacing)
    * [Typography](variables-and-maps#typography)
    * [Colors](variables-and-maps#colors)
* [Inheriting styles with mixins](inheriting-styles-with-mixins)
  * [Why mixins?](inheriting-styles-with-mixins#why-mixins)
  * [Available mixins](inheriting-styles-with-mixins#available-functions)
    * [Spacing](inheriting-styles-with-mixins#spacing)
    * [Typography](inheriting-styles-with-mixins#typography)
